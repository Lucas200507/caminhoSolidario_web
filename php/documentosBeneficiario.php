...
<head>
    ...
    <title>Documentos Beneficiários</title>
...
<body id="telaBody">
    ...
    <div class="d-flex justify-content-between w-100" id="titulo_home">
        <span class="text-start w-25">
            <h3 style="color: var(--cor_letras);">Documentos Beneficiário</h3>
        </span>
    ...
    <main class="mt-5 d-flex flex-column justify-content-center">
       ...
       <div class="container_documentos">
            <div class="containers_Documentos">
                <div class="subcontainers_Documentos">
