...
<head>
    ...
    <title>Frequencia Beneficiarios</title>
...
<body id="telaBody">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navegacaoHome">
            <ul class="navbar-nav ml-1 justify-content-around" id="navegadores_links">
                ...
                <li class="nav-item itens_navegadores">
                    ...
                    <a href="#" class="nav-link" id="linksNavegacaoSelecionado">Frequência</a>
                </li>
                <li class="nav-item itens_navegadores">
    ...
    <div class="d-flex justify-content-between w-100" id="titulo_home">
        <span class="text-start w-25">
            <h3 style="color: var(--cor_letras);">Frequência</h3>
        </span>
    ...
    <main style="height: 700px;" id="main_cadastro">
        <div class="container_icones_cadastro d-flex align-items-center flex-column" onclick="navegar_verificarFrequencia()">
            <ion-icon name="calendar-outline" class="icones_cadastro"></ion-icon>
            <p style="font-size: 25px; font-weight: bold;">Verificar Frequência</p>
        </div>
        <div class="container_icones_cadastro d-flex align-items-center flex-column" onclick="navegar_lancarFrequencia()">                
            <ion-icon name="checkbox-outline" class="icones_cadastro"></ion-icon>
            <p style="font-size: 25px; font-weight: bold;">Lançar Frequência</p>
        </div>
    </main>
