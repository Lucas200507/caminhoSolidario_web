...
<head>
    ...
    <title>Documentos - Caminho Solidario</title>
...
<body id="telaBody">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navegacaoHome">
            <ul class="navbar-nav ml-1 justify-content-around" id="navegadores_links">
                ...
                <li class="nav-item itens_navegadores">
                    ...
                    <a href="#" class="nav-link" id="linksNavegacaoSelecionado">Documentos</a>
                </li>
                <li class="nav-item itens_navegadores">
    ...
    <div class="d-flex justify-content-between w-100" id="titulo_home">
        <span class="text-start w-25">
            <h3 style="color: var(--cor_letras);">Documentos</h3>
        </span>
    ...
    <main style="height: 700px;" id="main_cadastro">
        <div class="container_icones_cadastro d-flex align-items-center flex-column"
            onclick="navegar_documentosBeneficiario()">
            <span style="position: relative;">
                <ion-icon name="document-text-outline" class="icones_cadastro"></ion-icon>
                <ion-icon name="person-outline" class="iconesPP_documentos"></ion-icon>
            </span>
            <p style="font-size: 25px; font-weight: bold;">Documentos Beneficiário(a)</p>
        </div>
        <div class="container_icones_cadastro d-flex align-items-center flex-column"
            onclick="navegar_documentosDependente()">
            <span style="position: relative;">
                <ion-icon name="document-text-outline" class="icones_cadastro"></ion-icon>
                <ion-icon name="people-outline" class="iconesPP_documentos"></ion-icon>
            </span>
            <p style="font-size: 25px; font-weight: bold;">Documentos Dependentes</p>
        </div>
